...
const NALLOWED: [Int; 13] = [8, 16, 32, 48, 64, 96, 128, 256, 384, 512, 1024, 2048, 4096];

pub struct Fft {
    pub lastn: Int,
    pub trigs: Vec<FloatNum>,
}

fn gp2fc(a: Int, n: Int, lot: Int, fft: &mut Fft) {
    let a: Vec2d<FloatNum> = vec![vec![0.0; lot as usize]; n as usize]; // (n,lot)

    if n != fft.lastn {
        fft.trigs = vec![0.0; n as usize];
        fft.lastn = n;
        // TODO
        // fftini(n);
    }
    ...
    while la >= 4 {
        // TODO
        // dfft4(a, fft.trigs, log, la);
    }

    if la == 3 {
        for l in 0..lot {
            // TODO
            // dfft3(a[0][l]), fft.trigs, n);
        }
    }
    ...
    if la == 2 {
        for l in 0..lot {
            // TODO
            // dfft2(a[0][l], fft.trigs, n);
        }
    }
}

fn fc2gp(a: Int, n: Int, lot: Int, fft: &mut Fft) {
    let a: Vec2d<FloatNum> = vec![vec![0.0; lot as usize]; n as usize];
    ...
    if nf == 2 {
        // TODO
        // ifft2(a, trigs, n, log, la);
    }
    if nf == 3 {
        // TODO
        // ifft3(a, trigs,n,log,la);
    }
    while la < n / 8 {
        // TODO
        // ifft4(a,trigs,n,log,la);
    }
...
fn fftini(n: Int, fft: &mut Fft) {
    ...
    if labort {
        ...
        // enddo
        panic!("selected resolution is not supported");
    }
    ...
    for k in 0..n/2-1 {
        angle = k * del;
        fft.trigs[2*k+1] = angle.cos();
        fft.trigs[2*k+2] = angle.sin();
    }

}

fn dfft2(a, trigs: &Vec<FloatNum>, n) {
